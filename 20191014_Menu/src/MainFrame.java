...
public class MainFrame extends javax.swing.JFrame {
    ...
    Color cData = new Color(0, 0, 255); // Color 초기화 (Black)
	...
	jPopupMenu1.add(mnuFile_Open);	// PopUp 메뉴에 mnuFileOpen 추가
	jPopupMenu1.add(mnuFile_Save);	// PopUp 메뉴에 mnuFileSave 추가
